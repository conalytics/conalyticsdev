...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link href="<c:url value="/resources/css/jquery.multilevelpushmenu_red.css"/>" rel="stylesheet">
        <link href="<c:url value="/resources/css/expandcollapse.css"/>" rel="stylesheet">
        ...
        <script src="<c:url value="/resources/js/expandcollapse.js" />"></script>
    </head>
    <body>
        <!--[if lt IE 7]>
        ...
        <div id="pushobj">
            <h1>this is application body</h1>
        </div>
        <div id="menu">
            <nav>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="#"><i class="fa fa-mobile-phone"></i>Super Smart Phone</a>
                                    </li>
                                    <li>
